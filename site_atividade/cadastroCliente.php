...
<body class="bg-light">
	...
	<div class="container mt-4" id="admClientes">		
		   <div class="text-center mt-5">
				<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal">Cadastro de Clientes</button>
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
							<form action="cadastroCliente.php" method="POST" class="was-validated">
								...
								<button type="submit" name="cadastrar" value="clientes" class="btn btn-primary">Cadastrar Cliente</button>
							</form>   
						</div>
					  <!-- Modal footer -->
